...
import (
	...
	"mycs/agent/cmd/kakao/kaosendrequest"
	"mycs/agent/cmd/msg/oshotproc"
	"mycs/agent/cmd/msg/lguproc"
	"mycs/agent/cmd/otp/otpatproc"
	"mycs/agent/cmd/otp/otplguproc"
	"mycs/agent/cmd/otp/otposhotproc"
